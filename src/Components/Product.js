        ...
        <>
          ...
          <Flex className="bottomNav">
            {favId.includes(product._id) ? (
              <>
                <Button
                  onClick={() => dispatch(REMOVE_FROM_WISHLIST(product._id))}
                  className="wishlistbuttonNav">
                  <AiFillHeart style={{ fontSize: "1rem", margin: "0 1rem" }} />
                  WISHLIST
                </Button>
              </>
            ) : (
                  ...
                  <Accordion defaultIndex={[0]} allowMultiple marginTop="2rem">
                    <AccordionItem className="accodianItem">
                      ...
                      <AccordionPanel pb={4}>
                        ...
                        <Text className="text" marginLeft="30px">
                          Hey Souledsters! You must have noticed that we've said
                          goodbye to the little Mr. Souls sleeve label that
                          we've had through the years. But always remember, when
                          you shop from our app, website, stores, or online
